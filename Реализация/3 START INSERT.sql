...
('Ryzen 7 3800XT',60000,30000,'Процессор представляет собой высокопроизводительное решение, которое может стать отличной основой для игровых и рабочих систем. ',2,2),
('GeForce GTX 1050',40000,20000,'Отличный выбор для пользователей, которые хотят создать игровую систему начального или среднего уровня.',3,3);
