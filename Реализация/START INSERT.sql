...
INSERT INTO product(price,description, manufacturer_id, type_id, price_purchases,name)
VALUES (20000,'Монитор способствует отображению детализированной и контрастной картинки, лишенной малейших искажений, поскольку в его основу положена матрица PLS.',1,1,10000,'S24F354FHI'),(60000,'Процессор представляет собой высокопроизводительное решение, которое может стать отличной основой для игровых и рабочих систем. ',2,2,30000,'Ryzen 7 3800XT'),(40000,'Отличный выбор для пользователей, которые хотят создать игровую систему начального или среднего уровня.',3,3,20000,'GeForce GTX 1050');
